...
function onLoadTimeChoiceDemo(){
    var demo = '<div class="borain-timeChoice-body">'+
        ...
        '<div class="choiceBox">'+
        '<div class="yearBox">'+
        '<a class="tbtn back" href="javascript:void(0);"><i class="fa fa-angle-left" aria-hidden="true"></i></a>'+
        '<div class="showBox">'+
        '<a class="year" href="javascript:void(0);"></a> - <a class="month" href="javascript:void(0);"></a>'+
        '</div><a class="tbtn forward" href="javascript:void(0);"><i class="fa fa-angle-right" aria-hidden="true"></i></a></div>'+
        ...
        '<a class="tbtn up fl" href="javascript:void(0);"><i class="fa fa-angle-up" aria-hidden="true"></i></a>'+
        '<span class="fl"><em></em> - <em></em></span>'+
        '<a class="tbtn down fr" href="javascript:void(0);"><i class="fa fa-angle-down" aria-hidden="true"></i></a>'+
        '</div>'+
        '<div class="year">'+
        '<!--加载年-->'+
        '</div>'+
