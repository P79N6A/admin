...
function checkaccount() {
	global $_W;
	$s_user_id = $_W['uid'];
	include './common_web_controler.php';
...
function buildframes($framename = ''){
	...
	$frames['system']['section']['wxplatform']['menu']['system_account']['title'] = "项目";
	$frames['system']['section']['wxplatform']['menu']['extension_module']['title'] = "项目模块";
  	$frames['system']['section']['wxplatform']['menu']['system_template']['title'] = "项目模板";
  	$frames['system']['section']['wxplatform']['menu']['system_platform']['title'] = "项目开放平台";
  	// $frames['system']['section']['wxplatform']['menu']['system_service_display']['title'] = "测试一下";
  	// $frames['system']['section']['wxplatform']['menu']['system_subscribe_subscribe']['title'] = "测试一下";
 
 	// $frames['system']['section']['module'] = " ";
 	unset($frames['system']['section']['module']);
