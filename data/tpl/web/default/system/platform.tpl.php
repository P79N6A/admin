...
<div id="js-system-platform" ng-controller="SystemPlatform" ng-cloak>
	<table class="table we7-table table-hover table-form we7-form">
		...
		<tr>
			...
			<th class="we7-padding-right">
				<a id="auth" href="<?php  echo $authurl;?>" class="btn btn-success"><i class="fa fa-wechat"></i>微信项目登录授权</a>
			</th>
		</tr>
		<tr>
		...
		<tr> 
			<td class="table-label" colspan="2">是否启用微信项目登录授权</td>
			<td>
				<label>
	...
	<table class="table we7-table table-hover table-form  we7-form">
		...
		<tr>
			<td class="color-red">项目消息校验Token</td>
			<td>
		...
		<tr>
			<td class="color-red">项目消息加解密Key</td>
			<td>
		...
		<tr>
			<td class="table-label">项目消息与事件接受URL</td>
			<td>
	...
	<div class="modal fade" id="token" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" id="newtoken" class="form-control" placeholder="请填写新的项目消息校验Token" />
						<span class="help-block">在微信开放平台注册且审核通过后可以获取到<span class="color-red">项目消息校验Token</span></span>
					</div>
				</div>
				<div class="modal-footer">
	...
	<div class="modal fade" id="encodingaeskey" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" id="newencodingaeskey" class="form-control" placeholder="请填写新的项目消息加解密Key" />
						<span class="help-block">在微信开放平台注册且审核通过后可以获取到<span class="color-red">项目消息加解密Key</span></span>
					</div>
				</div>
				<div class="modal-footer">
