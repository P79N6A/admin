...
<div id="js-user-edit-account" ng-controller="UserEditAccount" ng-cloak>
	...
	<table class="table we7-table table-hover vertical-middle">
		...
		<col width="240px"/>
		<tr>
			<th colspan="2" class="text-left">可使用的项目</th>
			<th>角色</th>
		...
		<tr ng-repeat="wechat in wechats" ng-if="wechats">
			...
			<td>
				<div class="link-group">
					<a ng-href="./index.php?c=account&a=post&do=base&uniacid={{wechat.uniacid}}&acid={{wechat.acid}}&account_type=<?php echo ACCOUNT_TYPE_OFFCIAL_NORMAL;?>" class="color-default">项目设置</a>
