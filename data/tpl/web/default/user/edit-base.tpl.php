	...
	<div class="modal fade" id="credit2" role="dialog">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" ng-model="userOriginal.credit2" class="form-control" placeholder="账号余额" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" ng-click="httpChange('credit2')">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
