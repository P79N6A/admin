...
<div class="main">
	<form action="<?php  echo $this->createWebUrl('recommend',array('op'=>'post'))?>" method="post">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline"><input type="radio" name="show_style" value="1" <?php  if(empty($recommend['show_style']) || $recommend['show_style'] == 1) { ?>checked="true"<?php  } ?> /> 单课程模式</label>
                        &nbsp;&nbsp;&nbsp;
                        <label class="radio-inline"><input type="radio" name="show_style" value="2" <?php  if($recommend['show_style'] == 2) { ?>checked="true"<?php  } ?> /> 专题+课程模式</label>
                        &nbsp;&nbsp;&nbsp;
                        <label class="radio-inline"><input type="radio" name="show_style" value="3" <?php  if($recommend['show_style'] == 3) { ?>checked="true"<?php  } ?> /> 单专题模式</label>
                    </div>
                </div>
                <div class="form-group">
