        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div style="padding-top:8px;font-size: 14px;"><a href="javascript:;" id="copy-btn"><?php  echo $_W['siteroot'];?><?php  echo str_replace("./", "", $this->createMobileUrl('search', array('pid'=>$category['id'])));?></a></div>
                    </div>
                </div>
				<?php  } else { ?>
				<div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">链接</label>
                    <div class="col-sm-9">
                        <div style="padding-top:8px;font-size: 14px;"><a href="javascript:;" id="copy-btn"><?php  echo $_W['siteroot'];?><?php  echo str_replace("./", "", $this->createMobileUrl('search', array('cid'=>$category['id'])));?></a></div>
                    </div>
                </div>
				<?php  } ?>
            </div>
