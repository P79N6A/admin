...
<ul class="nav nav-tabs">
	...
	<?php  if($op=='reply') { ?>
	<li <?php  if($op=='reply') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('evaluate', array('op'=>'reply','id'=>$_GPC['id']));?>">评价详情</a></li>
	<?php  } ?>
</ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <p class="form-control-static">
							<?php  if($evaluate['grade']==1) { ?><span class="label" style="background-color:#FB5B5B;">好评</span>
							<?php  } else if($evaluate['grade']==2) { ?><span class="label" style="background-color:#D99810;">中评</span>
							<?php  } else if($evaluate['grade']==3) { ?><span class="label" style="background-color:#555555;">差评</span><?php  } ?>
                        </p>
                    </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <p class="form-control-static">
							<textarea name="reply"  class="form-control" style="width:600px;height:150px;"><?php  echo $evaluate['reply'];?></textarea>
                        </p>
                    </div>
                </div>
				<div class="form-group">
