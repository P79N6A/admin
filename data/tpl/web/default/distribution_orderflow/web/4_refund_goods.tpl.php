...
<ul class="nav nav-tabs">
	<li <?php  if(!$op || $op == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('delivery', array('op' => 'display'));?>">申请退货列表</a></li>
</ul>
<style>
...
<div class="panel panel-info">
        <div class="panel-heading">解封</div>
        <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9 col-lg-9">
                        <input class="form-control" name="ipkeyword" id="ipkeyword" type="text" value="<?php  echo $_GPC['keyword'];?>" placeholder="请输入用户id">
                    </div>
                </div>
                <div class="form-group">
		...
		<table class="table table-hover" style="table-layout: initial;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php  echo $this->createWebUrl('delivery', array('op' => 'send_goods','id' => $item['id']))?>" title="发货" class="btn btn-sm btn-danger"><i class="fa fa-edit"></i></a>
						<a onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('delivery', array('op' => 'del','user_id' => $item['user_id']))?>" title="删除" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
