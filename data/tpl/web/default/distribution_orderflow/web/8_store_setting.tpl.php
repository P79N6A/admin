...
<ul class="nav nav-tabs">
	<li <?php  if(!$op || $op == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('store_setting', array('op' => 'display'));?>">参数列表</a></li>
	<li <?php  if($op == 'post'|| $op == 'edit') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('store_setting', array('op' => 'post'));?>">参数设置</a></li>
</ul>
<style>
		...
		<table class="table table-hover" style="table-layout: initial;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php  echo $this->createWebUrl('store_setting', array('op' => 'edit', 'id' => $item['id']))?>" title="编辑" class="btn btn-sm btn-default"><i class="fa fa-edit"></i></a>
						<a onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('store_setting', array('op' => 'del','id' => $item['id']))?>" title="删除" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
...
<div class="panel panel-info">
		<div class="panel-body">
			...
			<div class="form-group">
				...
				定金比例</label>
				<div class="col-sm-3">
					<input class="form-control" required="required" name="ratio" id='ratio' type="text" value="<?php  echo $item['ratio'];?>">
				</div>
			</div>
			<!-- <div class="form-group">
