						...
						<div id="content-modules" class="tab-pane active" role="tabpanel">
							<table class="table we7-table table-hover vertical-middle">
								...
								<tr>
									...
									<td><a class="btn btn-default js-btn-select <?php  if(is_array($current_module_names) && in_array($module_name, $current_module_names)) { ?>btn-primary<?php  } ?>" data-title="<?php  echo $module['title'];?>" data-name="<?php  echo $module['name'];?>" onclick="$(this).toggleClass('btn-primary')">选取</a></td>
								</tr>
								<?php  } ?>
								<?php  } } ?>
							</table>
