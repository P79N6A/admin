...
<div class="content-div-table">
	...
	<a href="http://kake.gangbengkeji.cn/web/index.php?c=site&a=entry&op=detail&do=index&m=member_system">
...
<div>
	...
	<div>
		<p>广州番禺信息科技有限公司</p>
		<p>程又青创建于2018-02-22 12:20</p>
	</div>
	<div class="input-group3">
		<div class="div">保存</div>
		<div class="div2">取消</div>
		<div class="clear"></div>
	</div>
</div>
<?php  } ?>
<script>
	$(function(){
		/*$('.content-table-tr').click(function(){
			var url="http://kake.gangbengkeji.cn/web/index.php?c=site&a=entry&op=detail&do=index&m=member_system";
		...
		$('.content-i-ul li').click(function(){
			...
			$('.input-group-addon img').attr('src','./resource/images/distribution_user/icon_arrow_right2.png');
