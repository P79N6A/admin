<?php defined('IN_IA') or exit('Access Denied');?><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('header_base', TEMPLATE_INCLUDEPATH)) : (include template('header_base', TEMPLATE_INCLUDEPATH));?>
<style>
	*{
