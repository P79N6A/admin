            ...
            <div class='panel-body' >
                ...
                <div class="form-group" style='padding:0 10px;'>
                    <table class='ordertable' style='table-layout:fixed'>
                        ...
                        <tr>
                            <td>订单金额：</td>
                            <td>￥<?php  echo number_format($item['price'],2)?> &nbsp;&nbsp;<a data-toggle='popover' data-html='true' data-placement='right' data-content="<table style='width:100%;'>
                <tr>
...
"><i class='fa fa-question-circle'></i></a></td>
                ...
                <tr>
                    ...
                    <table class='ordertable' style='table-layout:fixed;border-top:1px dotted #ccc'>
                        <tr>
                            <td style='width:120px'><h4>会员申请信息</h4></td>
                            <td></td>
                        </tr>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <h3 class="form-control-static">
                            ...
                            <?php  if($item['status'] == 1) { ?>
                                ...
                                <?php  if($item['isverify'] == 1) { ?>
                                    待使用
                                <?php  } else if(empty($item['addressid']) && empty($order_data)) { ?>
                                    待取货
                                <?php  } else if(!empty($order_data)) { ?>
                                    审核中
                                <?php  } else { ?>
