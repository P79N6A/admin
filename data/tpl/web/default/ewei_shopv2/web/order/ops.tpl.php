...
<a class="btn btn-primary btn-xs" data-toggle='ajaxPost'  href="<?php  echo webUrl('order/op/fetch', array('id' => $item['id']))?>" data-confirm="<?php  if(!empty($item['diyformdata'])) { ?>审核通过<?php  } else { ?>确认<?php  if(!empty($item['ccard'])) { ?>充值<?php  } else { ?>取货<?php  } ?><?php  } ?>吗？"><?php  if(!empty($item['diyformdata'])) { ?>审核通过<?php  } else { ?>确认<?php  if(!empty($item['ccard'])) { ?>充值<?php  } else { ?>取货<?php  } ?><?php  } ?></a>
<?php  if(!empty($item['diyformdata'])) { ?><a data-toggle="ajaxModal" href="<?php  echo webUrl('order/op/examine_refuse', array('id' => $item['id']))?>" class="btn btn-danger btn-xs">审核不通过</a><?php  } ?>
<?php  } ?>
<?php  } ?>
...
<?php  } ?>
<br><a class="btn btn-danger btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/delete',array('id'=>$item['id']))?>" data-confirm="确定删除该订单吗？">删除订单</a>
<!--yifuyuanma-->