...
<table class='table table-responsive' style='table-layout: fixed;'>
    ...
    <tr class='trorder'>
        ...
        <td colspan='4' style='text-align:right;font-size:12px;' class='aops'>
            ...
            <?php  if($item['upload_data'] || $item['diyformdata']) { ?>
            <a href="<?php  echo webUrl('order/vip/detail',array('order_id'=>$item['id']))?>">会员审核</a>
            <?php  } ?>
    ...
    <tr class='trbody'>
        ...
        <td rowspan="<?php  echo count($item['goods'])?>"  style='text-align: center;' >
            ...
            <?php  } else { ?>
            <?php  echo $item['address_send'];?>
            <?php  } ?>
        </td>
        <td rowspan="<?php  echo count($item['goods'])?>" style='text-align:center;' >

            <?php  if($item['statusvalue'] > 0 || $item['statusvalue'] == '-2') { ?>
...
"
        ...
        <td  rowspan="<?php  echo count($item['goods'])?>" style='text-align:center' >
            <?php  echo date('Y-m-d',$item['gettime'])?><br/><?php  echo date('H:i:s',$item['gettime'])?>
