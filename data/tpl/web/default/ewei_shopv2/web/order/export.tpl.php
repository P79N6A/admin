    ...
    <div class='panel-body'>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7 col-lg-9 col-xs-12">
                ...
                <button type="button" class="btn btn-success" onclick="downImg()">图片导出</button>
            </div>
        </div>
    </div>
...
<script language='javascript'>
    function downImg() {
        ...
        var expresssn = $('input[name=expresssn]').val();
        var member = $('input[name=member]').val();
        var paytype = $('select[name=paytype]').val();
        var status = $('select[name=status]').val();
        var saler = $('input[name=saler]').val();
        var storeid = $('select[name=storeid]').val();
        var merchtype = $('select[name=merchtype]').val();
        var export_dispatch = $('input[name=export_dispatch]:checked').val();
        var export_since = $('input[name=export_since]:checked').val();
        var export_verify = $('input[name=export_verify]:checked').val();
        var export_virtual = $('input[name=export_virtual]:checked').val();
        window.location = './index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=order.download&keyword='+keyword+'&expresssn='+expresssn+'&member='+member+'&paytype='+paytype+'&status='+status+'&saler='+saler+'&storeid='+storeid+'&merchtype='+merchtype+'&export_dispatch='+export_dispatch+'&export_since='+export_since+'&export_verify='+export_verify+'&export_virtual='+export_virtual;
    }
