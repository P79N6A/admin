        ...
        <table class="table table-hover table-responsive">
			...
			<div  >
					...
					>
                        ...
                        <?php  if($row['is_vip'] == 0) { ?>
                        <li>
                            <a data-toggle='ajaxRemove' data-confirm="确定设置改用户为会员？" title="设为会员" href="<?php  echo webUrl('member/list/vip',array('id'=>$row['id']))?>"><i class="fa fa-money"></i>设为会员</a>
                        </li>
                        <?php  } ?>
                        <?php  if($row['is_vip'] == 1) { ?>
                        <li>
                            <a href="<?php  echo webUrl('member/list/vip_check',array('id'=>$row['id']))?>" title="会员补充审核"><i class="fa fa-edit"></i>会员审核</a>
                        </li>
                        <?php  } ?>
