				...
				<div class="modal-body">
					<div class="we7-form">
						...
						<div ng-show="paysetting.wechat.switch == 2">
							<div class="form-group">
							<label for="" class="control-label col-sm-2">借用项目</label>
								<div class="form-controls col-sm-10">
									<select name="borrow" class="we7-select" ng-model="paysetting.wechat.borrow">
										<option value="" ng-selected="paysetting.wechat.borrow == 0 || paysetting.wechat.borrow == '' || paysetting.wechat.borrow == undefined">请选择要借用的项目</option>
						...
						<div ng-show="paysetting.wechat.switch == 3">
							<div class="form-group">
								<label for="" class="control-label col-sm-2">服务商项目</label>
								<div class="form-controls col-sm-10">
									<select name="service" class="we7-select" ng-model="paysetting.wechat.service">
										<option value="">请选择服务商项目</option>
