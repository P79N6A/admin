...
<div class="col-xs-12">
	<div class="col-xs-12" style="padding: 10px 0;">
		<a href="<?php  echo $this->createMobileUrl('member_detail',array('op'=>'display','member_id'=>$_GPC['member_id'],'agent_id'=>$_GPC['agent_id']))?>" class="btn" <?php  if($op == 'display') { ?>style="background:#fff;color: #333;"<?php  } ?>>赔率</a>
		<a href="<?php  echo $this->createMobileUrl('member_detail',array('op'=>'charge','member_id'=>$_GPC['member_id']))?>" class="btn" <?php  if($op == 'charge') { ?>style="background:#fff;color: #333;"<?php  } ?>>积分</a>
		<!-- <a href="<?php  echo $this->createMobileUrl('member_detail',array('op'=>'minus','member_id'=>$_GPC['member_id']))?>" class="btn" <?php  if($op == 'minus') { ?>style="background:#fff;color: #333;"<?php  } ?>>减值</a> -->
		<a href="<?php  echo $this->createMobileUrl('member_detail',array('op'=>'password','member_id'=>$_GPC['member_id']))?>" class="btn" <?php  if($op == 'password') { ?>style="background:#fff;color: #333;"<?php  } ?>>名称密码</a>
		<?php  if($status == 0) { ?>
	...
	<div class="col-xs-12" style="border: 1px solid #eee;">
		账号信息：<?php  echo $member['account'];?>(<?php  echo $member['credit1'];?>)
	</div>
