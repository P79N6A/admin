...
<body style="background-color: white; margin:0 auto; height:100%;width: 100%;font-family: 'Helvetica Neue', Helvetica, sans-serif;">
	...
	<form action="<?php  echo $this->createMobileUrl('login')?>" method="post">
		<div class="login-content">
			...
			<div style="margin-top: 3%; ">
				<input type="text" name="password" id="password" class="input-center" style="border: none;" placeholder="请输入密码">
			</div>
			<div style="border-top: 1px solid #EEEEEE;height:1px; margin-left: 20px;margin-right: 20px;"></div>
			<input type="submit" name="submit" id="login" class="btn_black" style="margin-top: 7%" value="登录">
		</div>
	</form>
</body>
</html>