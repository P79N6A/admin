...
<body style="width: 100%;height: 100% ;background-color: #ffffff;">
	<div class="account-head ">
		<div style="width: 7%;height: 18px;background-color: white;float: left;text-align: center;">
			...
			<div style="width: 93%;">
				<h2 id="account-date" style="font-weight: normal;font-size: 3vw;line-height: 3vw;text-align: center;">报表总期数（点我查询）</h2>
		</div>
	</div>
	<div class="qishu" id="xiaxianqishu">
		...
		<a href="<?php  echo $this->createMobileUrl('downline',array('agent_id'=>$_GPC['id'],'period_id'=>$item['id']))?>">
