	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="5d" value="<?php  echo $item['has_5D'];?>" id="5D<?php  echo $item['id'];?>">
				<input type="hidden" name="6d" value="<?php  echo $item['has_6D'];?>" id="6D<?php  echo $item['id'];?>">
