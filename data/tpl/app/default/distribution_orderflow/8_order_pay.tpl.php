...
<body>
	<div style="width: 100%;">
        <?php  if($is_weixin == 1) { ?>
        <form action="<?php  echo $this->createMobileUrl('web_payment',array('op'=>'post'))?>" method="post">
        <?php  } else { ?>
		<form action="<?php  echo $this->createMobileUrl('go_pay',array('op'=>'post'))?>" method="post">
        <?php  } ?>
	...
	<script type="text/javascript">
        ...
        window.onload = function() {
            if (status == 2 || pay_type == 4) {
                sendMessage('parent','pay_success');
            }
        }
