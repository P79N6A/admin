...
<body>
    <div style="width: 100%;height: 6vw;background: #fff;padding: 2vw 0;box-shadow: 0 5px 5px #eee;margin-bottom: 3vw;text-align: center;">
        <img src="../addons/distribution_orderflow/template/images/icon_arrow_left.png" style="height: 4vw;float: left;margin-left: 4vw;" onclick="location.href = 'http://kake.gangbengkeji.cn/wechat/html/mine/mine.html'">
        <span style="font-size: 4vw;">确认支付</span>
    </div>
    <form action="<?php  echo $this->createMobileUrl('web_recharge',array('op'=>post))?>" method="post">
    <div class="header">
        <?php  if($item) { ?>
