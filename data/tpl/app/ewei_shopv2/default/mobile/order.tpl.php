...
<div class='fui-page order-list-page ' style="margin-bottom: 25vw;">
    ...
    <%if (order.diyformdata==null || order.diyformdata == '') && order.status>0%>
    <%if order.viporder==0%>
    <a class="btn btn-sm btn-danger-o" href="<?php  echo mobileUrl('order/vip')?>&order_id=<%order.id%>">会员补充</a>
    <%/if%>
    <%if order.viporder>0 && order.vip < 2%>
    <a class="btn btn-sm btn-danger-o" href="<?php  echo mobileUrl('order/vip/show')?>&order_id=<%order.id%>">会员资料</a>
    <%/if%>
    <%if order.vip == 2%>
    <a class="btn btn-sm btn-danger-o" href="<?php  echo mobileUrl('order/vip')?>&order_id=<%order.id%>">会员补充</a>
    <%/if%>
    <%/if%>
    <%if (order.diyformdata!=null && order.diyformdata != '') && order.status==-2%>
    <a class="btn btn-sm btn-danger-o" href="<?php  echo mobileUrl('order/vip')?>&order_id=<%order.id%>">会员补充</a>
    <%/if%>
    <%if (order.diyformdata!=null && order.diyformdata != '') && (order.status==1 || order.status==3)%>
    <a class="btn btn-sm btn-danger-o" href="<?php  echo mobileUrl('order/vip/show')?>&order_id=<%order.id%>">会员资料</a>
    <%/if%>
