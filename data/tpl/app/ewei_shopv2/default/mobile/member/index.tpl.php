...
<div class='fui-page  fui-page-current'>
	...
	<div class="fui-cell-group fui-cell-click">
		<a class="fui-cell"  href="<?php  echo mobileUrl('order')?>">
			<div class="fui-cell-icon"><i class="icon icon-wodeyouhuiquan"></i></div>
			<div class="fui-cell-text"><p>会员资料补充</p></div>
			<div class="fui-cell-remark"><span class="badge"><?php  echo $supplement;?></span>
			</div>
		</a>
	</div>
