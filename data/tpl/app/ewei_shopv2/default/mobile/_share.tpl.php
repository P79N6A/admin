...
<script language="javascript">
        ...
        window.interval = setTimeout(function () {
            ...
            jssdkconfig.jsApiList = ['checkJsApi','onMenuShareTimeline','onMenuShareAppMessage','onMenuShareQQ','onMenuShareWeibo','showOptionMenu', 'hideMenuItems', 'onMenuShareQZone', 'scanQRCode','openLocation','chooseImage','uploadImage','getLocalImgData','downloadImage'];
