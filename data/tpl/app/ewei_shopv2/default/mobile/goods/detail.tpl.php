...
<div class='fui-page fui-page-current  page-goods-detail' id='page-goods-detail-index' style="overflow-x: hidden;">
    <?php  $this->followBar()?>
    <?php  if(empty($err)) { ?>
    <div class="fui-header">
        ...
        <div class="title">
            ...
            <div id="tab" class="fui-tab fui-tab-danger">
                ...
                <a data-tab="tab2" class="tab">用户心声</a>
...
<!--参数已完成-->
    <?php  if(count($params)>0) { ?>
    <div class="fui-content param-block  <?php  if(!$goods['canbuy']) { ?>notbuy<?php  } ?>" style="margin-bottom: 10vw;">
...
<!--商品详情已完成-->
    <div class="fui-content detail-block  <?php  if(!$goods['canbuy']) { ?>notbuy<?php  } ?>" style="top: 2rem;">
        <!-- <div class="text-danger look-basic"><i class='icon icon-unfold'></i> <span>上拉返回商品详情</span></div> -->
        <div class="content-block content-images" style="height: auto;background: #fff;"><img src="../attachment/images/comments.jpg"></div>
    </div>
<?php  } ?>

<div class='fui-content basic-block pulldown <?php  if(!$goods['canbuy']) { ?>notbuy<?php  } ?>' style="overflow: auto;">
...
<div class="content-block content-images" style="height: auto;background: #fff;"><?php  echo $goods['content'];?></div>
...
<div class="fui-navbar bottom-buttons">
    ...
    <a href="tel:075781168978" class="nav-item btn" style="background: #fd2222">一键拨号</a>
    <?php  if($canAddCart) { ?>
    ...
    <?php  } else { ?>
    <?php  if($_GPC['free'] == 0 || $freenum >= 60) { ?>
    <a href="<?php  echo mobileUrl('order/create',array('id'=>1))?>" class="nav-item btn" style="background: #fd5555">立即购买</a>
    <?php  } else { ?>
    <a href="<?php  echo mobileUrl('order/create',array('id'=>1,'free'=>1))?>" class="nav-item btn" style="background: #fd5555">免费购买</a>
    <?php  } ?>
    <?php  } ?>
    <?php  } ?>
</div>
