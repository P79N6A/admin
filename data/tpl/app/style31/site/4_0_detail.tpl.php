...
legend{color:#000;}
body{color:#222;background:#FFF6DB;font-family:Helvetica, STHeiti STXihei, Microsoft JhengHei, Microsoft YaHei, Tohoma, Arial;height:100%;position:relative;}
...
.head .bn.pull-left{border-right:1px solid #FFF6DB;}
.head .bn.pull-right{position:absolute; right:5px; top:0; border-left:1px solid #FFF6DB;}
